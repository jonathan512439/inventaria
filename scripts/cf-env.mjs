...
const APP_VARS = ["NEXT_PUBLIC_APP_URL", "NEXT_PUBLIC_SUPABASE_URL", "NEXT_PUBLIC_SUPABASE_ANON_KEY", "SUPABASE_SERVICE_ROLE_KEY", "GEMINI_API_KEY", "GEMINI_MODEL"];
const SECRET = new Set(["SUPABASE_SERVICE_ROLE_KEY", "GEMINI_API_KEY"]);
