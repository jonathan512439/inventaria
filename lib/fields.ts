...
export const BASIC_TEMPLATE: Array<Pick<FieldTemplate, "name" | "field_type" | "is_ai_fillable" | "options">> = [
  { name: "nombre", field_type: "text", is_ai_fillable: true, options: null },
  { name: "descripcion", field_type: "text", is_ai_fillable: true, options: null },
  { name: "color", field_type: "text", is_ai_fillable: true, options: null },
  { name: "categoria_sugerida", field_type: "text", is_ai_fillable: true, options: null },
  { name: "precio", field_type: "number", is_ai_fillable: false, options: null },
  { name: "precio_mayor", field_type: "number", is_ai_fillable: false, options: null },
  { name: "precio_compra", field_type: "number", is_ai_fillable: false, options: null },
  { name: "stock", field_type: "number", is_ai_fillable: false, options: null },
];
